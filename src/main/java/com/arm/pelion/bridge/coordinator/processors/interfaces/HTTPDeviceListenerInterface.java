/**
 * @file HTTPDeviceListenerInterface.java
...
/**
 * HTTP Device Listener Interface
 * @author Doug Anson
 */
public interface HTTPDeviceListenerInterface {
    ...
    // Poll for and process messages over HTTP
