/**
 * @file ReconnectionInterface.java
 * @brief Pelion Reconnection Interface
 * @author Doug Anson
 * @version 1.0
 * @see
 *
...
/**
 * Interface to undergo a MQTT re-connection sequence
 * @author Doug Anson
 */
public interface ReconnectionInterface {
    // restart our MQTT connection for the given device
