 ...
 * @author Doug Anson
 */
public class IoTHubDeviceManagerForHTTPProcessor extends DeviceManager {
    ...
    // constructor
    public IoTHubDeviceManagerForHTTPProcessor(IoTHubHTTPProcessor processor, HttpTransport http, String hub_name, String sas_token) {
        this(null, http, processor, hub_name, sas_token);
    }

    // constructor
    public IoTHubDeviceManagerForHTTPProcessor(String suffix, HttpTransport http, IoTHubHTTPProcessor processor, String hub_name,String sas_token) {
